...
// Source: github.com/xyedo/blindate/pkg/applications/service (interfaces: Attachment)
...
func (m *MockAttachment) UploadBlob(arg0 io.Reader, arg1 attachmentEntity.Uploader) (string, error) {
	m.ctrl.T.Helper()
