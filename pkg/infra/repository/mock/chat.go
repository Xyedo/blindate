...
// Source: github.com/xyedo/blindate/pkg/domain/chat (interfaces: Repository)
...
import (
	...
	chat "github.com/xyedo/blindate/pkg/domain/chat"
	chatEntity "github.com/xyedo/blindate/pkg/domain/chat/entities"
)

// MockChat is a mock of Repository interface.
...
func (m *MockChat) InsertNewChat(arg0 *chatEntity.DAO) error {
	m.ctrl.T.Helper()
...
func (m *MockChat) SelectChat(arg0 string, arg1 chat.Filter) ([]chatEntity.DAO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SelectChat", arg0, arg1)
	ret0, _ := ret[0].([]chatEntity.DAO)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
